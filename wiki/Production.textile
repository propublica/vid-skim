...
which will compile your entries to a @.json@ file and output the html in the @html@ directory.
...
# @DIVISION_ID@ Is a unique identifier for each division.
...
# @DIVISION_ID@ Is the unique identifier for the division associated with this entry.
# @TITLE@ Is the title of the entry, it appears along the timeline and the side rail of the *Video Skimmer*
# @['00:00:00', '00:00:00']@ is the range in @'hh:mm:ss'@ format, start and end.
# And finally each entry can have one or more lines of html code. 
