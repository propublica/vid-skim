...
<<<<<<< HEAD:example/html/javascripts/vid_skim.js
		  var max = this.max;
		  var transcript = this;
      ...
      setBounds: function(max) {
        if(this.max === 0){
          this.max = max;
    		  this.initTimeLine();
          this.draw(0);
>>>>>>> dce6939ef16ff865fa354692cbb20e4d44ca4132:example/html/javascripts/vid_skim.js
        }
      },
...
<<<<<<< HEAD:example/html/javascripts/vid_skim.js
    ...
    parametize: function (str) {
      var t = str;
      return t.toLowerCase().replace(/[^a-z0-9\-_\+]+/ig, '')
    },
...
>>>>>>> dce6939ef16ff865fa354692cbb20e4d44ca4132:example/html/javascripts/vid_skim.js
  ...
  // all that for this.
  window.Transcript = defineTranscript($);
