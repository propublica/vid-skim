...
!http://jashkenas.s3.amazonaws.com/images/vid-skim.png!
...
Then, write your video's JSON specification, using @videos/example.json@ as an example of the structure. When you're ready to build out the HTML page:
