...
Commands:
  ...
  Options:
    ...
    def configure
      @directory = VidSkim.configure(@directory)
    end
    ...
    def run_install
      ...
      Files.install_dir "#{VidSkim::ROOT}/template/html",   "#{@directory}/html"
      Files.install_dir "#{VidSkim::ROOT}/template/videos", "#{@directory}/videos"
    end
